...
// Helper to normalize category type to lowercase ('income', 'expense', 'asset', 'liability')
...
const getCategories = async (userId, options = {}) => {
  ...
  if (type) {
    ...
    query.type = { $regex: `^${normalizedType}$`, $options: "i" };
  }
...
const getDefaultCategories = () => {
  return [
    ...
    { _id: "default-bonus", name: "Bonus", type: "income", color: "#8b5cf6", icon: "Award", isCustom: false },
    { _id: "default-interest-income", name: "Interest Income", type: "income", color: "#14b8a6", icon: "Percent", isCustom: false },
    { _id: "default-dividend", name: "Dividend", type: "income", color: "#84cc16", icon: "PieChart", isCustom: false },
    { _id: "default-rental-income", name: "Rental Income", type: "income", color: "#eab308", icon: "Home", isCustom: false },
    { _id: "default-investment-returns", name: "Investment Returns", type: "income", color: "#22c55e", icon: "ArrowUpRight", isCustom: false },
    { _id: "default-refund", name: "Refund", type: "income", color: "#a855f7", icon: "RotateCcw", isCustom: false },
    ...
    { _id: "default-travel", name: "Travel", type: "expense", color: "#0ea5e9", icon: "Plane", isCustom: false },
    ...
    { _id: "default-emi", name: "EMI", type: "expense", color: "#f43f5e", icon: "Calendar", isCustom: false },
    { _id: "default-subscriptions", name: "Subscriptions", type: "expense", color: "#a855f7", icon: "Clock", isCustom: false },
    { _id: "default-personal-care", name: "Personal Care", type: "expense", color: "#ec4899", icon: "Smile", isCustom: false },
    ...
    { _id: "default-cash", name: "Cash", type: "asset", color: "#10b981", icon: "Wallet", isCustom: false },
    { _id: "default-savings", name: "Savings", type: "asset", color: "#14b8a6", icon: "PiggyBank", isCustom: false },
    { _id: "default-emergency-fund", name: "Emergency Fund", type: "asset", color: "#06b6d4", icon: "LifeBuoy", isCustom: false },
    ...
    { _id: "default-real-estate", name: "Real Estate", type: "asset", color: "#eab308", icon: "Home", isCustom: false },
    { _id: "default-gold-silver", name: "Gold / Silver", type: "asset", color: "#eab308", icon: "Sun", isCustom: false },
    { _id: "default-vehicle", name: "Vehicle", type: "asset", color: "#3b82f6", icon: "Car", isCustom: false },
    { _id: "default-electronics", name: "Electronics", type: "asset", color: "#64748b", icon: "Laptop", isCustom: false },
    ...
    { _id: "default-car-loan", name: "Car Loan", type: "liability", color: "#ec4899", icon: "Car", isCustom: false },
    { _id: "default-education-loan", name: "Education Loan", type: "liability", color: "#8b5cf6", icon: "BookOpen", isCustom: false },
    { _id: "default-business-loan", name: "Business Loan", type: "liability", color: "#6366f1", icon: "Briefcase", isCustom: false },
    { _id: "default-emi-liability", name: "EMI Liability", type: "liability", color: "#e11d48", icon: "Calendar", isCustom: false },
    { _id: "default-mortgage", name: "Mortgage", type: "liability", color: "#dc2626", icon: "Building", isCustom: false },
    { _id: "default-borrowed-money", name: "Borrowed Money", type: "liability", color: "#ea580c", icon: "HandCoins", isCustom: false },
    { _id: "default-taxes-payable", name: "Taxes Payable", type: "liability", color: "#b91c1c", icon: "FileText", isCustom: false },
